...
```
<p align="center">
  <img src="https://img.shields.io/badge/Labs-13%20%2F%2050-vividblue?style=for-the-badge&logo=docker" alt="Labs Progress">
...
`ZeroToShell-50` is a comprehensive, containerized training platform featuring **50 meticulously crafted Remote Code Execution (RCE) environments** spanning critical vulnerabilities from **2010 to 2026**. Each lab transforms real-world CVEs into deterministic, isolated, and fully reproducible exploitation scenarios.
...
# Navigate to any lab
cd labs/lab_04/CVE-2014-6172-Shell-shock
